...
export const meta: MetaFunction = () => {
  return [{ title: "Contribution History - Open Price Data" }];
};

export default function ContributionHistorySection() {
  const { userContributions } = useLoaderData<typeof loader>();
  return (
                          ...
                          {contributions.map((contribution) => (
                            ...
                            >
                              ...
                              {contribution.type === "receipt" ? (
                                // @ts-expect-error union type narrowing across receipt/price contribution shapes
