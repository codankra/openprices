      ...
      <div className="bg-white p-8 rounded-lg shadow-lg">
        <Form action="/auth" method="post" className="mb-4">
          <button
            name="authtype"
            value="google"
            className="flex items-center justify-center w-64 px-4 py-2 text-stone-700 bg-white rounded-md border border-gray-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 shadow-sm hover:shadow-md transition-all duration-200"
          >
